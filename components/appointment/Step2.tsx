...
const Step2 = () => {
  ...
  return (
    <div className="p-4">
    <h2 className="text-xl md:text-2xl font-semibold mb-4">Client Assessment Form</h2>
  
    <div className="mb-6">
      <h3 className="text-base md:text-xl font-semibold mb-2">Trauma History & Daily Routine</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="mb-4">
          ...
          <textarea
            ...
            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm md:text-base"
            rows={2}
          />
    ...
    <div className="mb-6">
      <h3 className="text-base md:text-xl font-semibold mb-2">Medical History & Additional Information</h3>
